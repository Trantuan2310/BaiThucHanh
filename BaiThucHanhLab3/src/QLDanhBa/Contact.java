...
public class Contact{
    ...
    public void AddContact(String ten, String phone){
        for(int i = 0; i < A.length; i++){
    ...
    public void UpdateContact(String ten, String newPhone){
        for(int i = 0; i < A.length; i++){
            if(A[i].ten.equals(ten)){
                A[i].phone = newPhone;
    ...
    public void DeleteContact(String ten){
        for(int i = 0; i < A.length; i++){
            if(A[i].ten.equals(ten)){
                A[i] = null;
    ...
    public void SearchContact(String ten){
        for(int i = 0; i < A.length; i++){
            if(A[i].ten.equals(ten)){
